...
import (
	...
	"github.com/asc521/bookings/internal/forms"
	"github.com/asc521/bookings/internal/helpers"
	"github.com/asc521/bookings/internal/models"
	"github.com/asc521/bookings/internal/render"
)
...
// Majors is the majors quarters page handler
func (m *Repository) Majors(w http.ResponseWriter, r *http.Request) {
	render.RenderTemplate(w, r, "majors.page.gohtml", &models.TemplateData{})
}

// Reservation is the make reservations page handler
